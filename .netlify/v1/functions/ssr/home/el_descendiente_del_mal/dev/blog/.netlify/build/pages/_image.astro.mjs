...
async function getConfiguredImageService() {
  if (!globalThis?.astroAsset?.imageService) {
    const { default: service } = await import(
      // @ts-expect-error
      '../chunks/astro/assets-service_hw-3dcod.mjs'
    ).then(n => n.s).catch((e) => {
...
}, "/home/el_descendiente_del_mal/dev/blog/node_modules/astro/components/Image.astro", void 0);
...
}, "/home/el_descendiente_del_mal/dev/blog/node_modules/astro/components/Picture.astro", void 0);
