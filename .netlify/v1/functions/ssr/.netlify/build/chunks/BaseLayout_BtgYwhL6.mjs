...
const $$BaseLayout = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`<html lang="en"> <head><meta charset="utf-8"><link rel="icon" type="image/svg+xml" href="/src/images/knowbud-512x512.svg"><link rel="icon" type="image/svg+xml" sizes="32x32" href="/src/images/knowbud-512x512.png"><meta name="viewport" content="width=device-width"><meta name="generator"${addAttribute(Astro2.generator, "content")}><title>${BLOG_NAME}</title>${renderHead()}</head> <body id="body-element" class="w-full h-full min-h-[100vh] transition-colors bg-blank-light text-obscure flex flex-col  dark:bg-obscure-dark dark:text-blank-light"> ${renderComponent($$result, "Header", Header, { "client:idle": true, "client:component-hydration": "idle", "client:component-path": "/home/el_descendiente_del_mal/dev/me/lcg-knowbud/src/components/Header", "client:component-export": "Header" })} <main class="w-full flex-1 mx-auto flex flex-col p-5 md:max-w-[900px]"> ${renderSlot($$result, $$slots["default"])} </main> ${renderComponent($$result, "Footer", $$Footer, {})} </body></html>`;
