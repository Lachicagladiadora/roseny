...
const $$BaseLayout = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`<html lang="en"> <head><meta charset="utf-8"><link rel="icon" type="image/svg+xml" href="/favicon.svg"><meta name="viewport" content="width=device-width"><meta name="generator"${addAttribute(Astro2.generator, "content")}><title>${BLOG_NAME}</title>${renderHead()}</head> <body id="body-element" class="w-full h-full min-h-[100vh] transition-colors bg-blank-light flex flex-col  dark:bg-obscure-dark  text-obscure-dark dark:text-blank-light"> ${renderComponent($$result, "Header", Header, { "client:idle": true, "client:component-hydration": "idle", "client:component-path": "/home/el_descendiente_del_mal/dev/me/lcg-knowbud/src/components/Header", "client:component-export": "Header" })} <main class="w-full flex-1 mx-auto flex flex-col p-5 md:max-w-[900px]"> <h1 class="pt-6 pb-2 text-4xl font-bold text-first-dark dark:text-second">${`${pageTitle}`}</h1> <hr class="text-first-dark dark:text-second"> ${renderSlot($$result, $$slots["default"])} </main> ${renderComponent($$result, "Footer", $$Footer, {})} </body></html>`;
